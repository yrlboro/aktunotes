...
> >
> > DWRR: nilai $i$ yang memenuhi $-CF_0 - CF_{0{,}5}(1+i)^{-0{,}5} + V_1(1+i)^{-1} = 0$
>
> **Diketahui:**
...
> > [!info]+ **Rumus**
> >
> > Amortisasi retrospektif: $OB_t = OB_{t-1}(1+i) - \text{PMT}_t$
> >
...
> > [!info]+ **Rumus**
> >
> > Rate kuartalan: $j_q = (1{,}06)^{1/4} - 1$
> >
> > PV perpetuitas kuartalan: $\dfrac{150}{j_q}$ (dihitung di t=6, lalu diskonto ke t=0)
>
> **Diketahui:**
...
> > [!info]+ **Rumus**
> >
> > Bunga majemuk 6 bulan: $FV_A = PV \cdot (1+i)^{0{,}5}$
> >
> > Bunga sederhana 6 bulan: $FV_B = PV \cdot (1 + i \cdot 0{,}5)$
>
> **Diketahui:** $PV = 10{.}000$, $i = 10\%$, $t = 0{,}5$ tahun
>
> > [!example]- Langkah Pengerjaan
> >
...
> > [!info]+ **Rumus**
> >
> > OB setelah $k$ cicilan: $OB_k = R \cdot a_{\overline{n-k}|i}$
> >
> > Cicilan baru: $R_{\text{baru}} = (OB_k + \text{Hutang Baru}) / a_{\overline{n-k}|i_{\text{baru}}}$
>
> **Diketahui:**
...
> >
> > Limit: $d^{(m)} = m(1-(1+i)^{-1/m}) \to \ln(1+i) = \delta$ saat $m \to \infty$
>
> > [!example]- Langkah Pengerjaan
> >
...
> > [!info]+ **Rumus**
> >
> > Persamaan Fisher: $1 + i_r = \dfrac{1 + i_n}{1 + q}$
>
...
> > [!info]+ **Rumus**
> >
> > FV annuity-due: $\ddot{s}_{\overline{n}|i} = (1+i) \cdot \dfrac{(1+i)^n-1}{i}$
>
> **Diketahui:**
